...
| `message_extensions`      | false       | _`List<Message Extension>`_ | Data necessary to support requirements not defined in the standard 3DS format. |
...
| `message_extensions` | `List<Message Extension>` | Data necessary to support requirements not defined in the standard 3DS format |
