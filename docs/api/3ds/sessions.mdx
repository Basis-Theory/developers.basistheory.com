...
const session = await bt.threeds.getSession("c06d0789-0a38-40be-b7cc-c28a718f76f1");
```
...
const session = await bt.threeds.authenticateThreeDsSession("c06d0789-0a38-40be-b7cc-c28a718f76f1", {
...
var authentication = await client.AuthenticateThreeDSSession(new AuthenticateThreeDSSessionRequest {
  AuthenticationCategory = "payment",
  AuthenticationType = "payment-transaction",
