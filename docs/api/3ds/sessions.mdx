...
| Attribute | Required | Type | Description
| --- | --- | --- | --- |
| `amex_requestor_type` | true | _string_ | The 3DS requestor id |
| `cb_siret_number` | true | _string_ | The 3DS requestor name |
| `discover_client_id` | true | _string_ | A business URL for the 3DS requestor |
