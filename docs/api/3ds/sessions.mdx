...
<Alert type={Alerts.WARNING}>
  3DS sessions of type `customer` (CIT) are  only officially supported through our <a href="/docs/sdks/web/3ds/">web</a>, <a href="/docs/sdks/mobile/3ds-react-native">react-native</a> and <a href="/docs/sdks/mobile/3ds/">mobile</a> SDKs.
