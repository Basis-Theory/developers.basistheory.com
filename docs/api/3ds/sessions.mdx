...
<Alert type={Alerts.WARNING}>Customer 3DS session creation is only officially supported through our <a href="/docs/sdks/web/3ds/">web</a>, <a href="/docs/sdks/mobile/3ds-react-native">react-native</a> and <a href="/docs/sdks/mobile/3ds/">mobile</a> SDKs.</Alert>
...
```json showLineNumbers
{
  ...
  "session_id": "bde59c80-08e9-45e3-b2a4-530a4dff1e8d",
  "threeds_version": "2.2.0",
  "acs_transaction_id": "330bafb9-c397-4b58-b256-ac5dd131c6b5",
  "ds_transaction_id": "cb56d6fb-61e4-4949-900d-692fa1c25634",
  "acs_reference_number": "mock-acs-reference-number",
  "ds_reference_number": "mock-directory-server-a",
...
| `acs-timed-out` | ACS request timed out. |
...
| `vmid-not-eligible-for-requested-program` | Merchant ID not eligible for 3DS program, reach out to Basis Theory. |
| `protocol-version-not-supported-by-acs` | ACS does not support this protocol version, reach out to Basis Theory. |
| `device-3ri-not-routed-to-smart-authentication-stand-in` | Device-initiated transaction routing issue. |
