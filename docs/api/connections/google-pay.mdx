...
import com.basis.theory.api.resources.connections.GooglePayClient;
import com.basis.theory.api.models.GooglePayTokenizationRequest;

TokenIntent tokenIntent = new GooglePayClient(
    ClientOptions.builder()
        .addHeader("BT-API-KEY", "<API_KEY>")
        .build()
).tokenize(GooglePayTokenizationRequest.builder()
    .googlePaymentMethodToken(new HashMap<String, Object>() {{
        put("protocolVersion", "ECv2");
        put("signature", "...");
        put("intermediateSigningKey", new HashMap<String, Object>() {{
            put("signedKey", "...");
            put("signatures", Arrays.asList("..."));
        }});
        put("signedMessage", "...");
    }})
    .build());
