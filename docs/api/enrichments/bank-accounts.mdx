...
| routing_number    | String (Optional) | The routing number of the bank account. Only applicable with tokens of type [`us_bank_account_number`](/docs/api/tokens/token-types#us-bank-account-number) |
