...
import com.basis.theory.api.resources.enrichments.EnrichmentsClient;

EnrichmentsClient client = new EnrichmentsClient(
    ClientOptions.builder()
        .addHeader("BT-API-KEY", "<API_KEY>")
        .build()
);

BankVerificationResult result = client.bankAccountVerify(BankVerificationRequest.builder()
...
```
  ...
  <TabItem value="go" label="Go">
    ...
    result, err := client.Enrichments.BankAccountVerify(ctx, verifyRequest)
    ```
  </TabItem>
</Tabs>
