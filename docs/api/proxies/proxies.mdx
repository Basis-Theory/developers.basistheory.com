...
| `application_id`     | _string_                                     | (Optional) This Application's API key is injected into a pre-configured [Node.js BasisTheory](https://www.npmjs.com/package/@basis-theory/basis-theory-js) instance passed into the Reactor's runtime. Must be a `public` or `private` [Application Type](/docs/api/applications#application-types). |
