...
| `configuration`      | false    | _map_                                                      | `null`  | A string key and string value map of all configuration name and values for a [Proxy Transform](#proxy-transform-object)                                                                                                                                            |
...
| `configuration`      | _map_                                        | (Optional) A string key and string value map of all configuration name and values for a [Proxy Transform](#proxy-transform-object)                                                                                                                                            |
