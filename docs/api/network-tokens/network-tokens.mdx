...
| cardholder_info                      | Yes      | object | Contains the cardholder's personal information    |
| cardholder_info.name                 | Yes      | string | The full name of the cardholder                   |
| cardholder_info.address              | Yes      | object | Contains the cardholder's address details         |
| cardholder_info.address.line1        | Yes      | string | The first line of the street address              |
| cardholder_info.address.line2        | No       | string | The second line of the street address             |
| cardholder_info.address.line3        | No       | string | The third line of the street address              |
| cardholder_info.address.postal_code  | Yes      | string | The postal code of the address                    |
| cardholder_info.address.city         | Yes      | string | The city of the address                           |
| cardholder_info.address.state_code   | No       | string | The state or province code of the address         |
| cardholder_info.address.country_code | Yes      | string | The country code of the address                   |
