...
|--------------------|--------------------------|--------------------------|
| `4111111111111111` | Success                  | [Not Apply]              |
...
| Test PAN           | Response                 | Error Title              |
|--------------------|--------------------------|--------------------------|
| `5555555555554444` | Success                  | [Not Apply]              |
...
| Test PAN           | Response                 | Error Title              |
|--------------------|--------------------------|--------------------------|
| `6011111111111117` | Success                  | [Not Apply]              |
...
| Test PAN          | Response                 | Error Title              |
|-------------------|--------------------------|--------------------------|
| `378282246310005` | Success                  | [Not Apply]              |
...
In addition to the card-specific errors below, you may also encounter these error codes when transforming a Token or Token Intent into a Network Token:

| Error Title                | Description                                                                                    |
|----------------------------|------------------------------------------------------------------------------------------------|
| CARD_NUMBER_LENGTH_INVALID | The card number does not meet the required length. Please check the card number and try again. |
| CARD_DATA_MISSING          | Required card data (card number, expiration year, and/or expiration month) is missing.         |
