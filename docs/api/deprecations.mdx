...
| `token:<classification>:*` permissions                              | October 13, 2022  | October 13, 2022 | Classification and impact level based permissions have been migrated to [Access Rules](/docs/concepts/access-controls#what-are-access-rules) to provide a more flexible model for scoping access to a subset of Tokens via [Containers](/docs/concepts/what-are-containers). For more information, see the [table below](#migrating-permissions-to-access-rules).                                               |
...
have automatically been migrated to equivalent [Access Rules](/docs/concepts/access-controls#what-are-access-rules).
Refer to [Migrating Permissions to Access Rules](#migrating-permissions-to-access-rules) below for further details.

## Migrating Permissions to Access Rules

Permissions on existing Applications have been automatically migrated to equivalent [Access Rules](/docs/concepts/access-controls#what-are-access-rules),
