...
- Rotate Via the Portal
  - If you created your keys via the [Portal](https://portal.basistheory.com) - follow this guide:
    - Go to the [Applications List](https://portal.basistheory.com/applications)
    - Find the Applications needing keys rotated and Edit.
  ...
  - Once you are done updating all your systems with the new value, click the "trash" icon to delete the "Legacy" key. (Only do this once all usages of the keys have been updated)
...
- Rotate via API
  - [Create a new key](https://developers.basistheory.com/docs/api/applications/application-keys#create-application-key) for the Applications
  - Update your systems with the new key
  - Once all systems have been updated, delete the [old key](/docs/api/applications/application-keys#delete-application-key)
