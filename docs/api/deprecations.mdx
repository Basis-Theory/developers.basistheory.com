...
| Apple Pay™ and Google Pay™ Tokenization                             | August 05, 2022   |                   | Connection endpoints for [Apple Pay™](/docs/api/connections/apple-pay) and [Google Pay™](/docs/api/connections/google-pay) have been deprecated and replaced by a more flexible set of endpoints: [Apple Pay™](/docs/api/apple-pay/api) and [Google Pay™](/docs/api/google-pay/api). For instructions on how to migrate please refer to [Apple Pay™ migration guide](/docs/api/connections/apple-pay#migration-guide) and [Google Pay™ migration guide](/docs/api/connections/google-pay#migration-guide). |
