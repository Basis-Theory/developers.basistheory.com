...
| Application Key Regenerate                                          | April 17, 2024    | October 17, 2024               | Regenerating API Keys for an Appliation has been replaced with [Application Keys](/docs/api/applications/application-keys), to Migrate you will Create a new Application Key and remove the old key. |
