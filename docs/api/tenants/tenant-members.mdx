...
Page<TenantMember> page = client.tenantMembers().list();
```
...
```java showLineNumbers
client.tenantMembers().delete("memberId");
```
...
```java showLineNumbers
TenantInvitation invitation = client.tenantInvitations().create(TenantInvitation.builder()
    .email("jane@doe.com")
    .role("ADMIN")
    .build());
```
...
```java showLineNumbers
TenantInvitation resentInvitation = client.tenantInvitations().resend("invitationId");
```
...
```java showLineNumbers
Page<TenantInvitation> page = client.tenantInvitations().list();
```
...
```java showLineNumbers
TenantInvitation invitation = client.tenantInvitations().get("invitationId");
```
...
```java showLineNumbers
client.tenantInvitations().delete("invitationId");
```
