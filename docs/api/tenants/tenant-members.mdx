...
new TenantMembersClient(ClientOptions.builder().build()).list();
```
...
```java showLineNumbers
new TenantMembersClient(ClientOptions.builder().build()).delete("memberId");
```
...
```java showLineNumbers
new TenantInvitationsClient(ClientOptions.builder().build()).create(TenantInvitation.builder()
    .email("jane@doe.com")
    .role("ADMIN")
    .build());
```
...
```java showLineNumbers
new TenantInvitationsClient(ClientOptions.builder().build()).resend("invitationId");
```
...
```java showLineNumbers
new TenantInvitationsClient(ClientOptions.builder().build()).list();
```
...
```java showLineNumbers
new TenantInvitationsClient(ClientOptions.builder().build()).get("invitationId");
```
...
```java showLineNumbers
new TenantInvitationsClient(ClientOptions.builder().build()).delete("invitationId");
```
