...
| `token_deduplication_behavior` | _string_ | Whether tokens [deduplicated](/docs/concepts/what-are-tokens#deduplication) have their data sections updated (Update Existing) or remain unchanged (Read Existing). [Token Intents](/docs/concepts/token-intents) do not use this setting and are always deduplicated with the Update Reading behavior.                                                                                                                                                                 |
