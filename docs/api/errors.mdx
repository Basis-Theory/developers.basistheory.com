...
In general, errors are returned with a response body that conforms to the "Problem Details"
[RFC 7807](https://datatracker.ietf.org/doc/html/rfc7807) specification, as documented below.
