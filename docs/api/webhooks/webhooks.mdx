...
This URL should will be registered with Basis Theory when you setup the webhook.

The receiver should be capable of handling HTTP POST requests.
It's recommended to use HTTPS to secure the data in transit, protecting it from potential interception.
