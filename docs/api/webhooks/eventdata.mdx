...
### Reactor Completed Asynchronously

```json title="reactor.completed-async"
{
  "reactor": {
    "id": "..."
  },
...
|------------------|--------|------------------------------------------------------|
| reactor.id       | String | The unique identifier of the [reactor](/docs/api/reactors/#reactor-object).                |
| request.id       | String | The unique identifier of the request. Can be used to [retrieve the results](/docs/api/reactors#retrieve-result) of the invocation. |
