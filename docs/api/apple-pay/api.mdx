...
<Alert type={Alerts.INFO}>
  Tenants can register up to 99 domains.
</Alert>

If you are interacting directly with any Apple APIs, you may be required to set an Apple merchant ID.
In these cases, the merchant ID will be your tenant ID.
