...
Token token = client.tokenize(new HashMap<String, String>() {{
    put("first_name", "John");
    put("last_name", "Doe");
}});
```
...
Token token = client.tokenize(Token.builder()
    .type("token")
    .data("Sensitive Value")
...
Token cardToken = client.tokenize(Token.builder()
    .type("card")
...
List<Object> result = client.tokenize(tokens);
```
...
Map<String, Object> result = client.tokenize(new HashMap<String, Object>() {{
    put("first_name", "John");
    put("last_name", "Doe");
