...
```javascript showLineNumbers
await client.tokenIntents.retrieve("665bf471-d675-4165-9336-4fc9c1a73fad");
```
...
const tokenIntent = await bt.tokenIntents.retrieve("665bf471-d675-4165-9336-4fc9c1a73fad");
```
  </TabItem>
