...
TokenIntent tokenIntent = client.tokenIntents().create(TokenIntent.builder()
    .type("card")
...
```java showLineNumbers
TokenIntent tokenIntent = client.tokenIntents().get("665bf471-d675-4165-9336-4fc9c1a73fad");
```
...
```java showLineNumbers
client.tokenIntents().delete("dda42a6b-964b-46d8-b315-eb6dfda37c32");
```
