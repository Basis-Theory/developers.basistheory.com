...
import com.basis.theory.api.resources.tokens.TokenIntentsClient;

TokenIntentsClient client = new TokenIntentsClient(
    ClientOptions.builder()
        .addHeader("BT-API-KEY", "<API_KEY>")
        .build()
);

TokenIntent tokenIntent = client.create(TokenIntent.builder()
    .type("card")
...
TokenIntent tokenIntent = client.get("665bf471-d675-4165-9336-4fc9c1a73fad");
```
...
client.delete("dda42a6b-964b-46d8-b315-eb6dfda37c32");
```
