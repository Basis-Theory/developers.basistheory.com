...
Map<String, String> detokenizedData = new TokensClient(ClientOptions.builder().build())
...
```java showLineNumbers
Map<String, Object> detokenizedData = new TokensClient(ClientOptions.builder().build())
