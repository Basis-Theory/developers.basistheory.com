...
Map<String, String> detokenizedData = client.tokens().detokenize(new HashMap<String, String>() {{
...
```java showLineNumbers
Map<String, Object> detokenizedData = client.tokens().detokenize(new HashMap<String, Object>() {{
