...
| `enrichments`            | _any_                 | An object containing the enrichments applied to this token. See [Token Enrichments](/docs/api/tokens/token-enrichments) for available enrichements.                                              |
