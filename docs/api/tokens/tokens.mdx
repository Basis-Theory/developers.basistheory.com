...
The `encrypted` attribute enables you to create tokens from encrypted payloads generated using [Client Encryption Keys](/docs/api/client-keys). This approach allows for client-side encryption of sensitive data and provides more control over when data is sent to Basis Theory.
