...
| `encrypted`              | false    | _string_               | `null`                                                    | An encrypted payload that contains the token data. See [Encrypted Token Creation](/docs/sdks/web/web-elements/services#encrypting-data) for more details.                                    |
