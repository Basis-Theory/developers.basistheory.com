...
new ApplicationsClient(ClientOptions.builder().build()).create(Application.builder()
    .name("My Application")
    .type("private")
    .build());
```
...
```java showLineNumbers
new ApplicationsClient(ClientOptions.builder().build()).update("id", Application.builder()
    .name("My Example App")
