...
| `rules`       | false    | _array_  | `[]`    | An array of [Access Rules](/docs/api/applicatins/access-rules#access-rules) granted to the application.             |
...
| `rules`       | _array_  | List of [access rules](/docs/api/applicatins/access-rules#access-rules) granted to the Application    |
