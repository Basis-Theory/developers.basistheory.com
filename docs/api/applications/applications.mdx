...
Application application = client.create(Application.builder()
    .name("My Application")
    .type("private")
    .metadata(metadata)
    .build());
...
List<Application> applications = client.list();
```
...
Application application = client.get("id");
```
...
Application application = client.getByKey();
```
...
Application updatedApplication = client.update("id", Application.builder()
    .name("My Example App")
