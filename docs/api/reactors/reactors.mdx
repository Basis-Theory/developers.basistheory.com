...
ReactorsClient client = new ReactorsClient(
    ClientOptions.builder()
        .addHeader("BT-API-KEY", "<API_KEY>")
        .build()
);

Reactor reactor = client.create(Reactor.builder()
    .name("My Reactor")
...
Reactor updatedReactor = client.update(Reactor.builder()
    .id("id")
    .name("My Reactor")
    .applicationId("application-id")
    .configuration(new HashMap<>())
...
Reactor updatedReactor = client.patch(Reactor.builder()
    .id("id")
    .name("My Reactor")
    .configuration(new HashMap<>() {{
...
Map<String, Object> response = client.react("id", new HashMap<>() {{
...
Map<String, Object> result = client.results().get("id", "requestId");
```
  </TabItem>
