...
| `configuration`  | true     | _object_ | `null`  | A string key and string value map of predefined configuration names and values accessible from the [Reactor code](#reactor-code)                                                                                                                                                                            |
...
| `configuration`  | false     | _object_ | `null`  | A string key and string value map of predefined configuration names and values accessible from the [Reactor code](#reactor-code)                                                                                                                                                                            |
| `application.id` | false     | _uuid_   | `null`  | This Application's API key is injected into a pre-configured [BasisTheory JS SDK](/docs/sdks/server-side/node) instance passed into the Reactor's runtime. Must be a `public` or `private` [Application Type](/docs/api/applications#application-types).                                  |
...
| `configuration` | _map_                                                                           | A string key and string value map of predefined configuration names and values accessible from the [Reactor code](#reactor-code)                                                                                                                                                                                       |
...
| `configuration` | _object_ | A string key and string value map of all configuration name and values defined when creating the [Reactor](#reactor-object) |
