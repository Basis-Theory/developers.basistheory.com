...
Reactor reactor = new ReactorsClient(ClientOptions.builder().build())
    .create(Reactor.builder()
        .name("My Reactor")
...
```java showLineNumbers
Reactor updatedReactor = new ReactorsClient(ClientOptions.builder().build())
    .update(Reactor.builder()
        .id("id")
        .name("My Reactor")
        .applicationId("application-id")
        .configuration(new HashMap<>())
