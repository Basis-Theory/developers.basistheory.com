...
Reactor reactor = client.reactors().create(Reactor.builder()
    .name("My Reactor")
...
```java showLineNumbers
Page<Reactor> page = client.reactors().list();
```
...
```java showLineNumbers
Reactor reactor = client.reactors().get("id");
```
...
```java showLineNumbers
Reactor updatedReactor = client.reactors().update("id", Reactor.builder()
    .name("My Reactor")
    .applicationId("application-id")
    .configuration(new HashMap<>())
    .metadata(new HashMap<>() {{
...
```java showLineNumbers
Reactor updatedReactor = client.reactors().patch(
    "id",
    Reactor.builder()
        .name("My Reactor")
        .configuration(new HashMap<>() {{
...
```java showLineNumbers
Map<String, Object> response = client.reactors().react("id", new HashMap<>() {{
...
```
    ...
    <TabItem value="java" label="Java">
```java showLineNumbers
Map<String, Object> result = client.reactors().results().get("id", "requestId");
```
  </TabItem>
