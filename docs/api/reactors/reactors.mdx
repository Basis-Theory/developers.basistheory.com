...
<Alert>The maximum payload size to invoke a Reactor is 5 MB. You could pull in more data using the injected <code>BT</code> client from within the Reactor code. <a href="https://basistheory.com/contact">Please reach out</a> if you need help.</Alert>
