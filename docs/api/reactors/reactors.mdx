...
| `applicationOptions`             | _object_               | An object containing configuration information for the [@basis-theory/basis-theory-js](/docs/sdks/web/javascript/) SDK      |
| `applicationOptions.apiKey`      | _string_               | An API key for the [@basis-theory/basis-theory-js](/docs/sdks/web/javascript/) SDK                                          |
| `applicationOptions.environment` | _string_               | The Basis Theory API URL for the [@basis-theory/basis-theory-js](/docs/sdks/web/javascript/) SDK                            |
