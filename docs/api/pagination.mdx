...
Most `List` endpoints support offset pagination to allow bulk fetching multiple items. Each `List` endpoint shares a common response structure. Examples of these requests can be seen in [List Applications](/docs/api/applications#list-applications) and [List Tokens](/docs/api/tokens#list-tokens).
...
| Attribute     | Type      | Description                                                                              |
| ------------- | --------- | -----------------------------------------------------------------------------------------|
| `after`       | _string_  | Cursor to get the next set of results.                                                   |
