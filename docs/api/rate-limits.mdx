...
| -------- | ------- | ---- | ------ |
| POST /tokens/search | IP | 50 req / 10 s | Throttle |
| GET /tokens | IP | 100 req / 10 s | Throttle |
| POST /tokens OR /tokenize | IP | 200 req / 10 s | Throttle |
| PATCH /tokens/{'{id}'} | IP | 200 req / 10 s | Throttle |
