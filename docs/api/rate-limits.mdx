...
<Alert>These new rate limits will go into effect on July 16, 2024. Read more about it in our blog [Introducing New Rate Limits](https://blog.basistheory.com/introducing-new-rate-limits). Reach out to your account manager or [contact us](https://basistheory.com/contact) with any questions or concerns.</Alert>
