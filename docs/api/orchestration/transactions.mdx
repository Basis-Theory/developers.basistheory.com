...
| `payment_service_refund_id` | string      |         | The payment service's unique ID for the refund.                                                                                                               |
...
| `target_type`               | enum        |         | The type of the instrument that was refunded. Available options: payment-method, gift-card-redemption                                                         |
| `target_id`                 | string      |         | The optional ID of the instrument that was refunded. This may be null if the instrument was not stored.                                                       |
