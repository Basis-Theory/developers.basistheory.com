...
| `exp_month`        | false    | _string_ | `null`  | String representing the card's expiration month                      |
| `exp_year`         | false    | _string_ | `null`  | String representing the card's expiration year                       |
