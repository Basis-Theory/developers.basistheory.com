...
<Alert type={Alerts.ERROR}>Reactor Formulas have been <a href="/docs/api/deprecations#deprecated-features">deprecated</a> in favor of the <code>code</code> property for Reactors.</Alert>
...
Returns a [paginated object](/docs/api/pagination#offset-pagination-object) with the `data` property containing an array of [Reactor Formulas](#reactor-formula-object). Providing any query parameters will filter the results. Returns [an error](/docs/api/errors) if Reactor Formulas could not be retrieved.
...
| `coming_soon` | The formula has limited availability. Request <a href="https://support.basistheory.com/hc/requests/new?tf_subject=Join%20Private%20Beta%20for%20Reactor%20Formula&amp;tf_description=Let%20us%20know%20which%20reactor%20formula%20you'd%20like%20to%20use&amp;tf_priority=normal" target="_blank">a new formula template</a>. |
