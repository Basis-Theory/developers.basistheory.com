...
| `basisTheoryConfig`            | An object capable of being used when initializing the [Basis Theory JS SDK](/docs/sdks/server-side/node) for the. `const client = new BasisTheoryClient(basisTheoryConfig);` |
