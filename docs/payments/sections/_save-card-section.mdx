...
- The **Network Transaction identifier**, returned by the processor during the initial transaction; allowing you to seamlessly charge the card with new processors or acquirers in the future and achieve the best approval rates. Refer to your current processor’s documentation or support for guidance on accessing this value.
- (Optional) The card **brand**, **expiration date** and **last four digits**, available in the [Token Intent](/docs/api/tokens/token-intents#token-intent-object) or [Token](/docs/api/tokens/#token-object) object.
  - You can skip storing this information by [retrieving the token](http://localhost:3000/docs/api/tokens/#get-a-token) before rendering saved cards to your customer.
...
| CUSTOMER_ID | BT_CARD_TOKEN                          | PSP_TOKEN                     | NT_TX_ID                           | CARD_BRAND | CARD_EXP | CARD_LAST4 |
|-------------|----------------------------------------|-------------------------------|------------------------------------|------------|----------|------------|
| `a7c9f2b4`  | `1cd9c8bf-99fd-4784-ba69-68b15b301019` | `pm_1Hh1xD2eZvKYlo2CgdS6Kh4u` | `8723dfab9c4e56a1b8cd0291ef67ac43` | _VISA_     | 01/30    | 4242       |
