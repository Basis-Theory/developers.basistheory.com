...
import BankBlueprint from "@site/static/img/getting-started/bank-blueprint.png";
...
<Card.TwoColumnLayout>
  <BlueprintCard
    ...
    heading="Card Blueprint"
    img={<img src={CardBlueprint} alt="Card Blueprint" />}
  >
  ...
  <BlueprintCard
    href="/docs/blueprints/cards"
    heading="Bank Blueprint"
    img={<img src={BankBlueprint} alt="Bank Blueprint" />}
  >
    A complete guide to meet 95% of the compliance requirements of PCI using
    Basis Theory in as little as 5 minutes.
  </BlueprintCard>
</Card.TwoColumnLayout>
