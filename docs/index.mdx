...
import CardBlueprint from "@site/static/img/getting-started/card-blueprint-background.svg";
import BankBlueprint from "@site/static/img/getting-started/bank-blueprint-background.svg";
