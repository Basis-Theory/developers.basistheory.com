...
And call Basis Theory API to [create the Proxy](/docs/api/proxies/pre-configured-proxies#create-a-proxy):
...
- [Error Handling](/docs/api/reactors/invoke-reactors#reactor-error-codes)
