...
Now that we have access to the encrypted payment data, we can use our newly created public key to send the payment data using the [Google Pay](/docs/api/orchestration/google-pay) endpoint.
