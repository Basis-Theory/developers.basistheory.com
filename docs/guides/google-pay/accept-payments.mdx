...
### Tokenize the Googe Pay Payment Data
...
In Adyen, you can charge a card by creating a [payment](https://docs.adyen.com/api-explorer/Checkout/latest/post/payments). We'll setup and invoke the [ephemeral Proxy](/docs/api/proxies/ephemeral-proxy) on our backend.

```javascript showlineNumbers title="Charge Payment method through a Proxy"
