...
Once a challenge is complete (a decoupled challenge notification is received), results are retrieved by calling the [Get Challenge Result](/docs/api/3ds/sessions#get-challenge-result) endpoint from your backend.
