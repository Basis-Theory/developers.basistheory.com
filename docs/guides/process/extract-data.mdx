...
<Alert>
  Be sure to replace <code>&lt;API Key></code> with the Management API Key you created in the <a
...
<Alert>
  ...
  <ul>
    <li>
      <code>&lt;API Key></code> with the Management API Key you created in the <a href="#getting-started">Getting
      Started</a> step;
    </li>
    <li>
...
<Alert>
  ...
  <ul>
    <li><code>&lt;API Key></code> with the Private API Key you created in the <a
