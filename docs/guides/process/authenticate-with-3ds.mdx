...
In this guide, we will set up the Basis Theory 3DS SDK to start a 3DS Customer Initiated Transaction (CIT) in a frontend web application, and securely authenticate it using the Basis Theory Platform.
...
<div className={styles["sdk-column"]}>
  ...
  <Card
    href="/docs/sdks/mobile/3ds-react-native/"
    img={<React />}
    className={styles.sdk}
