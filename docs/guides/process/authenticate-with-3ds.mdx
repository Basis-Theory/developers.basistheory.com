...
The 3DS SDK is available as an NPM package and also available for Android and iOS apps.
...
threeDSService = try ThreeDSService.builder()
  ...
  .withAuthenticationEndpoint("Your 3DS authentication endpoint URL") // https://developers.basistheory.com/docs/guides/process/authenticate-with-3ds#authenticating-a-session
...
<Alert>Styling of the challenge window is not supported in the mobile SDK\'s. Contact <a href="mailto:support@basistheory.com?subject=Styling 3DS mobile">support@basistheory.com</a> for more information.</Alert>
