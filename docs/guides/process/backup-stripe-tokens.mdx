...
In the metadata object you can pass any of the Basis Theory token properties documented [here](/docs/api/orchestration/stripe-forward#stripe-metadata).
...
// highlight-next-line
--data-urlencode 'request[body]={"card": { "number": "", "exp_month": "", "exp_year": "", "cvc": "", "name: "" }, "metadata": { "containers": ["/pci/high/"] } }' \
