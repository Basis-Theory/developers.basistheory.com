...
<Alert>
  Be sure to replace <code>&lt;MANAGEMENT_API_KEY></code> with the Management API Key you created in the <a href="#getting-started">Getting Started</a> step.
</Alert>
...
<Alert>Save the API Key from the created Private Application as it will be used in this guide to create tokens and invoke our reactor.</Alert>
...
<Alert>
  Be sure to replace <code>&lt;PRIVATE_API_KEY></code> with the Private API Key you created in the <a href="#create-a-private-application">Create a Private Application</a> step.
</Alert>
...
<Alert>
  ...
  <ul>
    <li>
      <code>&lt;PRIVATE_API_KEY></code> with the Private API Key you created in the <a href="#create-a-private-application">Create a Private Application</a> step
    </li>
    <li>
