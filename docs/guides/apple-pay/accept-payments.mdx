...
This application utilizes the [Apple Pay demo application](https://applepaydemo.apple.com/apple-pay-js-api) and the [Basis Theory Apple Pay demo application](https://github.com/Basis-Theory/apple-pay-developer-demo-app).
