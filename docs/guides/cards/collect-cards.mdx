...
[![Collect Cards Flowchart](/img/guides/cards/collect-cards-flowchart.png)](https://mermaid.live/edit#pako:eNpdUV1LwzAU_SvhPm3QzLXrx5oHYU4FwYGoKNj6kDV3Npg2JU3VOfbfTbupaF6Sc-4591xyd1BogcCAUprXVlqFjCy1UlhYsuRGtORS6fei5Mbm9SDafGNyfZvXxJ22W78Y3pRECvRJdsZb2ZL7ErXZPh8Ub7xTNhs99Nf4yPFGZoubq19E6emgOxBYi3_dN0iyR1yTE7LSa6mQLJrm6EaFFda2HfUjk4sjGv8tUtpXS60EGiK45S7Qxf7EgQcVmopL4f5j19M52NJ5c2DuKbh5zSGv907HO6vvtnUBzJoOPega1w_PJXeTVsA2XLWObXgNbAcfwJJJGsZBGvvBPJ4liQdbYHQ28YMgisM0DKIw8qNw78Gn1s7vT6ZJlKaBP52ncZzMpr4HKKTVZnXY1rC0IeBpMAyB-y8IVZD_)

If you are looking for a way to use your inputs to capture your user's cards, and understand the security concerns and compliance impact it represents, follow the [Collect Cards With Your Inputs](/docs/guides/cards/collect-cards-with-your-inputs) guide.
...
<Alert>
  Alternatively, you can follow <a href="/docs/guides/cards/collect-cards-single-element">this guide</a> for using a single <code>CardElement</code> with Javascript or React.
</Alert>
...
- [Process Card Payments](/docs/guides/cards/process-card-payments)
- [Display Cards](/docs/guides/cards/display-cards)
