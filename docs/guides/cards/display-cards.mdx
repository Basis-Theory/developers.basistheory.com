...
![Display Cards](/img/guides/cards/display-cards-flowchart.png)
...
- [Issue Cards](/docs/guides/cards/issue-cards) - create brand-new cards using an Issuer API;
- [Collect Cards](/docs/guides/cards/collect-cards) - capture cards in the frontend;
- [Receive Cards via API](/docs/guides/cards/receive-cards) - receive cards in API requests;
- [Import from a Database](/docs/migrations/import-from-database) - migrate to Basis Theory.
