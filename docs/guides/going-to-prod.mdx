...
The questions are persistent to the browser (local storage), and can be reset by clearing website data. Incognito windows can also be used to start a new questionnaire.
