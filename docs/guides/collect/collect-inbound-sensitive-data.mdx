...
<Alert>
  Be sure to replace <code>&lt;API Key></code> with the Management API Key you created in the <a href="#getting-started">Getting Started</a> step.
</Alert>
...
<Alert>
  Be sure to replace <code>&lt;API Key></code> with the Management API Key you created in the <a href="#getting-started">Getting Started</a> step and replace <code>45c124e7-6ab2-4899-b4d9-1388b0ba9d04</code> with the <code>id</code> of the Public Application you created in the <a href="#create-a-public-application">Getting Started</a> step.
</Alert>
