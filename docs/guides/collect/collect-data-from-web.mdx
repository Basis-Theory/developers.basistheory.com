...
Now we need to initialize Basis Theory JavaScript Elements. To do this, we will create an instance of `BasisTheory` with `elements: true` to dynamically load **Elements** module in `index.js`:
...
This step will add a [Text Element](/docs/sdks/web/javascript/types#text-element) component to our page.
