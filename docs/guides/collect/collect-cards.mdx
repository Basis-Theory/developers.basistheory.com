...
<Alert>
  Alternatively, you can follow <a href="/docs/guides/collect/collect-cards-single-element">this guide</a> for using a single <code>CardElement</code> with Javascript or React.
</Alert>
...
class ViewController: UIViewController {
    ...
    @IBAction func submit(_ sender: Any) {
        ...
        BasisTheoryElements.tokenize(body: body, apiKey: "<API Key>") { token, error in
