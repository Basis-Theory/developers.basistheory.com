...
<Alert>
  If you are <a href="#using-a-single-card-element">using a single Card Element</a>, simply pass its reference as the <code>data</code> attribute of the token payload.
</Alert>
