...
<Alert type={Alerts.WARNING}>This guide is deprecated. Check out our updated guide: [Replace Processor iFrames](/docs/card-payments/replace-processor-iframes)</Alert>
