...
If you are looking for a way to use your inputs to capture your user's cards, and understand the security concerns and compliance impact it represents, follow the [Collect Cards With Your Inputs](/docs/card-paymets/use-your-own-inputs) guide.
