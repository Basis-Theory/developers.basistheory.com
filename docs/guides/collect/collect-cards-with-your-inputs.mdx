...
async function init () {
  //highlight-start
  bt = await new BasisTheory().init('test_1234567890');
  //highlight-end
};
...
export default function App() {
  const { bt } = useBasisTheory('test_1234567890');
