...
<Alert>
  Be sure to replace <code>&lt;API Key></code> with the Management API Key you created previously.
</Alert>
...
1. `<API Key>` is the Management Application Key, used to authenticate the request;
...
<Alert>
  Be sure to replace <code>&lt;API Key></code> with the Private Application Key and <code>TDEyQmkhQMpGiZd13FSRQ9</code> with the Proxy Key you created previously.
</Alert>
