...
- [Elements Services](/docs/sdks/web/javascript/services)
...
Finally, we want to be able to set focus to our Text Element input when the form loads and block clicking the submit button until the phone number input is complete. Basis Theory offers several [events](/docs/sdks/web/javascript/events) and [methods](/docs/sdks/web/javascript/services) to assist with these types of operations.
