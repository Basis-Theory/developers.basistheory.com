...
- [React Elements](/docs/sdks/web/react-elements)
...
We will need to install Basis Theory's [React Elements SDK](/docs/sdks/web/react-elements), which will render a secure iFrame for capturing the data.
...
This code is importing the Basis Theory React SDK, initializing the SDK via `useBasisTheory`, and adding the [BasisTheoryProvider](/docs/sdks/web/react-elements#basistheoryprovider) context provider.
