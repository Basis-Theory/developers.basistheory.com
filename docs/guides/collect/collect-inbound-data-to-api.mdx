...
The Basis Theory Proxy leverages a [request transform](/docs/api/proxies/#proxy-transform-object), which is executed in a Node.js 16 runtime. The following code will handle tokenizing the request:
