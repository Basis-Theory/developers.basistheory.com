...
Now it's time to style our new `CardNumberElement`. We'll be styling our element programmatically, but you can also style it through the activity's XML or the GUI on Android Studio.
