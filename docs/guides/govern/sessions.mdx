...
<Alert>
  Be sure to replace <code>test_priv_1234567890</code> with the Private API Key
  you created in the{" "}
...
<Alert>
  Be sure to replace <code>test_pub_1234567890</code> with the Public API Key
  you created in the{" "}
...
<Alert>
  Be sure to replace <code>test_sess_1234567890</code> with the Session Key you
