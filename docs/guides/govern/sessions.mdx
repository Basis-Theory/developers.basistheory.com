...
<Alert>
  Be sure to replace <code>&lt;PRIVATE_API_KEY></code> with the Private API Key
  you created in the{" "}
...
<Alert>
  Be sure to replace <code>&lt;PUBLIC_API_KEY></code> with the Public API Key
  you created in the{" "}
...
<Alert>
  Be sure to replace <code>&lt;SESSION_API_KEY></code> with the Session Key you
