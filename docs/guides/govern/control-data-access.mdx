...
<Alert>
  Be sure to replace <code>&lt;API Key></code> with the Private API Key you created in the <a href="#create-a-private-application">Create a Private Application</a> step.
</Alert>
