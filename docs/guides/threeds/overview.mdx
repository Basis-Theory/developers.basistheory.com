...
<Card.TwoColumnLayout>
  ...
  <Card
    column
    img={<LogoGuides />}
    href="/docs/guides/threeds/implementation-cit-redirect"
    heading="3DS Implementation (CIT Redirect)"
  >Learn how to integrate and test Customer Initiated Transactions (CIT) with redirection, ensuring seamless authentication for one-time payments.</Card>
  <Card
    column
    img={<LogoGuides />}
