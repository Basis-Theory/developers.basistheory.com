...
<Alert type={Alerts.INFO}>
  It is best practice to securely collect your data from a <a href="/docs/guides/collect/collect-data-from-web">web form</a> or <a href="/docs/guides/collect/collect-inbound-sensitive-data.mdx">API</a> to avoid security and compliance risks associated with directly handling the sensitive data.
</Alert>
