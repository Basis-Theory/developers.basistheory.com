...
<Alert>
  Be sure to replace <code>&lt;API Key></code> with the Private API Key you created in the <a href="#getting-started">Getting Started</a> step and replace <code>d2411dd4-17f0-47ce-a4e2-78a66f2e4606</code> with the token <code>id</code> you created in the <a href="#create-a-token">Create a Token</a> step.
</Alert>
