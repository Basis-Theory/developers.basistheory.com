...
<div className={styles["sdk-column"]}>
  <Card href="/docs/sdks/web/javascript/" img={<JavaScript />} className={styles.sdk} openInNewWindow={true}>Javascript</Card>

  <Card href="/docs/sdks/web/react/" img={<ReactSvg />} className={styles.sdk} openInNewWindow={true}>React</Card>
