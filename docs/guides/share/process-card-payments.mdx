...
Next, you will need need a [Private Application](/docs/api/applications) using our PCI-compliant template `Use PCI Tokens`. [Click here to create one.](https://portal.basistheory.com/applications/create?application_template_id=31efed55-035c-4b49-b1a1-609a728d91ce)
