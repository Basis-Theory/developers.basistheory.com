...
<Alert>Save the API Key from the created Management Application as it will be used to provision the next step.</Alert>
...
<Alert>Save the API Key from the created Private Application as it will be used in this guide to create the token and retrieve the masked data.</Alert>
