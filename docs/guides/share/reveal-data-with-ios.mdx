...
# Reveal Data with iOS

This guide will show you how to reveal data to a customer in an iOS application without touching the data.
In this guide, we will be revealing credit card data (number and expiration date) collected and tokenized with Basis Theory, along with the card verification code from an issuer, in this case, [Lithic](https://www.lithic.com/).

Key concepts in this guide:

- [Tokens](/docs/concepts/what-are-tokens)
- [Applications](/docs/api/applications)
- [Proxy](/docs/api/proxies)
...
- Name - Reveal Data from iOS Guide
