...
<QuestionCard question="Did you include a reference to the data storage at Basis Theory in your user terms of service?">
  <Content type="no">
    <Alert type="warning">You can have your team add the following: "COMPANY uses Basis Theory, a third-party service provider for payment tokenization. Learn more about <a href="https://basistheory.com" target="_blank">Basis Theory</a>."</Alert>
  </Content>
</QuestionCard>
