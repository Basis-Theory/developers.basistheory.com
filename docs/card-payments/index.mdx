...
import VerifyCards from "@site/static/img/guides/cards/verify-cards.svg";
import KeepCardsUpToDate from "@site/static/img/guides/cards/keep-cards-up-to-date.svg";
import Backup from "@site/static/img/guides/cards/backup.svg";
import AdoptingBasisTheory from "@site/static/img/guides/cards/adopting-basis-theory.png";
...
<img src={AdoptingBasisTheory} alt="Adopting Basis Theory"/>
...
<Card.TwoColumnLayout>
  ...
  <Card
    column
    img={<Backup/>}
    href="/docs/guides/process/backup-stripe-tokens"
...
<Card.TwoColumnLayout>
  <Card
    column
    img={<KeepCardsUpToDate/>}
    href="/docs/guides/account-updater/overview"
    heading="Keep Cards Up to Date"
  >Update cards once, use them everywhere, no PCI hassle.</Card>
</Card.TwoColumnLayout>
