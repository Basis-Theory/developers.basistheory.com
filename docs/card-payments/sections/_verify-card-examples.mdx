...
<Alert>
  <p>**You are not restricted** to the Payment Processors listed above. As long as your partner can accept cards through an API endpoint, you can invoke it using the Ephemeral Proxy.</p>
  <p>Please <a href="https://basistheory.com/contact">contact us</a> if you need assistance with performing card transactions against a specific processor.</p>
</Alert>
