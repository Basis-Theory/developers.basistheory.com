...
![Verify a Card Diagram](/img/guides/cards/verify-card-diagram.png)
...
Here is how you can leverage the [Ephemeral Proxy](/docs/api/proxies/invoke-ephemeral-proxies), a tool that transparently performs detokenization, to share the sensitive cardholder data to the Payments Processor or Acquirer API.
