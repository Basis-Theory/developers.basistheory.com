...
<Alert>
  Be sure to replace <code>lithic_token_id</code> with the ID for the Lithic card <code>id</code>, <code>test_proxy_123456789</code> with the proxy <code>key</code> created in the <a href="#creating-a-proxy-to-lithic">Creating a Proxy to Lithic</a> step
   and <code>card_token_id</code> with your Basis Theory card token <code>id</code>.
</Alert>
