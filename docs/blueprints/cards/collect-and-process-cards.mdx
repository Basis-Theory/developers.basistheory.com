...
This blueprint assumes you are using a [React](https://reactjs.org/) frontend and [Node.js](https://nodejs.org/en/) API. The blueprint can be modified for your specific framework or language by leveraging our [JavaScript Elements implementation](/docs/sdk/webs/javascript-elements) or one of our many language-specific SDKs.
