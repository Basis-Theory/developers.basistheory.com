...
Now, we need to add a [`CardElement`](/docs/sdks/web/web-elements/types#card-element) component to our form. This Element type renders a single line containing input fields to capture the card number, expiration date, and CVC.
