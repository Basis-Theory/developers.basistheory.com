...
Our SDKs provide several types of inputs to collect various types of data, such as the [CardElement](./elements/types#card-element)
for collecting credit card data and [TextElement](./elements/types##text-element) for collecting arbitrary textual data.
