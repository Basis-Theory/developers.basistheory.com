...
<Alert type={Alerts.ERROR}>[Basis Theory React](https://www.npmjs.com/package/@basis-theory/basis-theory-react) SDK has been deprecated. Visit [react-elements](/docs/sdks/web/react-elements/) for the latest SDK. For any questions, contact [support@basistheory.com](mailto:support@basistheory.com).</Alert>
...
```javascript showLineNumbers
import { useRef } from "react";
import type { CardExpirationDateElement } from "@basis-theory/react-elements/types";
