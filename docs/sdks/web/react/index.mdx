...
<Alert type={Alerts.ERROR}>[Basis Theory React](https://www.npmjs.com/package/@basis-theory/basis-theory-react) SDK has been deprecated. Follow the steps below to migrate to the latest SDK. For any questions, contact [support@basistheory.com](mailto:support@basistheory.com).</Alert>
