...
| `transform`    | false    | _RegExp_             | true      | `RegExp` object or [array](/docs/sdks/web/javascript/options#transform) used to modify user input before [tokenization](/docs/sdks/web/react/methods#tokenization-services)                    |
...
| `ref`          | false    | _object/function_    | false     | [Ref object](/docs/sdks/web/react#using-refs)/[Callback ref function](https://react.dev/learn/referencing-values-with-refs) to store/receive the Element instance.                               |
| `value`        | false    | _string_             | true      | Sets a static value for the element input.                                                                                                                                                 |
| `validation`   | false    | _RegExp_             | true      | [`RegExp` object] used to validate user input (on match) before [tokenization](/docs/sdks/web/react/methods#tokenization-services)                                                    |
