...
| `transform`    | false    | _RegExp_             | true      | `RegExp` object or [array](/docs/sdks/web/javascript/options#transform) used to modify user input before [tokenization](/docs/sdks/web/javascript/methods#tokenization)                    |
