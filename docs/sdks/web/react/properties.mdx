...
Text elements allow you to modify user input before [tokenization](/docs/sdks/web/javascript/methods#tokenization) through the
...
`1234567890` which will be what gets [tokenized](/docs/sdks/web/javascript/methods#tokenization).
