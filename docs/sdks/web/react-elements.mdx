...
This [Context Provider](https://reactjs.org/docs/context.html) shares an instance of the React Elements SDK to your component tree, making it available for [Elements Components](./react/components) or other custom components.
...
When using Typescript, you can type-cast the element `ref` to safely to a specific [Elements Component type](./react/components).
