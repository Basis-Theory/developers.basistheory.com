...
- [Detailed initialization guide](/docs/sdks/elements/initialization)
- [Element types and examples](/docs/sdks/elements/types)
- [Styling and options](/docs/sdks/elements/options)
- [Event handling](/docs/sdks/elements/events)
- [Services (tokenization and sessions)](/docs/sdks/elements/services)
- [Element lifecycle](/docs/sdks/elements/lifecycle)
- [React-specific components](/docs/sdks/elements/components)

## Additional Resources

- [Implementation guides](/docs/guides/collect/collect-data-from-web)
- [Code examples](https://github.com/Basis-Theory/basis-theory-js-examples)
- [API Reference](/docs/api/tokens) 