...
Basis Theory Elements can securely encrypt sensitive data using public key and Key ID created through [Encryption Keys](/docs/api/client-keys).
...
bt.tokens
  .encrypt({
    ...
    public_key: "base64 encoded PEM file with public key",
    key_id: "ECC93C58-CAF0-4179-BC56-09C21984B7BD" // Key identifier
  })
  .then((response) => {
...
bt.tokens
  .encrypt({
    ...
    public_key: "base64 encoded PEM file with public key",
    key_id: "ECC93C58-CAF0-4179-BC56-09C21984B7BD"
  })
  .then((response) => {
