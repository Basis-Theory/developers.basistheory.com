...
| coBadgedSupport | `array` | No | Accepts co-branded cards, currently only supports `cartes-bancaires` |
...
| binLookup | `boolean` | Yes | cardElement, cardNumber | Enables BIN lookup |
| coBadgedSupport | `array` | Yes | cardElement | Accepts co-branded cards, currently only supports `cartes-bancaires` |
