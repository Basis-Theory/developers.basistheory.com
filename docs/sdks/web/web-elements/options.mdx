...
| `cardTypes`          | false    | _array_   | false     | [`cardNumber`](/docs/sdks/web/javascript/types#card-number-element)                                                                                                                                                                                                                                                                                                                     | [Brand identifier](#card-brands) used to determine proper input format and default placeholder/aria-label                                                                                                                                                         |
| `copyIconStyles`     | false    | _object_  | false     | [`cardNumber`](/docs/sdks/web/javascript/types#card-number-element)<br/>[`cardExpirationDate`](/docs/sdks/web/javascript/types#card-expiration-date-element)<br/>[`cardElement`](/docs/sdks/web/javascript/types#card-element) <br/>[`cardVerificationCode`](/docs/sdks/web/javascript/types#card-verification-code-element)                                                            | Object used to customize the copy icon `size`, `color` and `successColor`                                                                                                                                                                                         |
...
| `maxLength`          | false    | _number_  | false     | [`text`](/docs/sdks/web/javascript/types#text-element)                                                                                                                                                                                                                                                                                                                                  | Defines the maximum string length that the user can enter into the TextElement. [Learn more](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/maxlength)                                                                                              |
...
| `placeholder`        | false    | _string_  | true      | All                                                                                                                                                                                                                                                                                                                                                                                     | String used to customize the [placeholder attribute](https://developer.mozilla.org/docs/Web/HTML/Element/input#attr-placeholder) of the input. Card element takes a [`CardElementPlaceholder`](/docs/sdks/web/javascript/options#card-element-placeholder) object |
...
| `skipLuhnValidation` | false    | _boolean_ | false     | [`cardElement`](/docs/sdks/web/javascript/types#card-element)<br/> [`cardNumber`](/docs/sdks/web/javascript/types#card-number-element)                                                                                                                                                                                                                                                  | Disables Luhn Validation for Card Element and Card Number Element                                                                                                                                                                                                 |
...
| `validateOnChange`   | false    | _boolean_ | false     | [`text`](/docs/sdks/web/javascript/types#text-element)<br/>[`cardNumber`](/docs/sdks/web/javascript/types#card-number-element)<br/>[`cardExpirationDate`](/docs/sdks/web/javascript/types#card-expiration-date-element)<br/>[`cardElement`](/docs/sdks/web/javascript/types#card-element) <br/>[`cardVerificationCode`](/docs/sdks/web/javascript/types#card-verification-code-element) | Switches from default validation `onBlur` to `onChange`.                                                                                                                                                                                                          |
| `validation`         | false    | _RegExp_  | true      | [`text`](/docs/sdks/web/javascript/types#text-element)                                                                                                                                                                                                                                                                                                                                  | [`RegExp` object] used to validate user input. Runs validation on blur by default                                                                                                                                                                                 |
