...
element.off('change', handlerFunction);
```
...
If you encounter any issues during migration that aren't covered in this guide, please contact <a href="mailto:support@basistheory.com">support@basistheory.com</a> for assistance.
</Alert>