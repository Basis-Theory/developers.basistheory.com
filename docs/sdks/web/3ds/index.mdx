...
<Alert type={Alerts.WARNING}>The Web 3DS SDK uses <code>methodFrameContainer</code> and <code>challengeFrameContainer</code> as pre-defined HTML element IDs for its operation. Avoid creating elements with the same id as they could be modified by the SDK.</Alert>
