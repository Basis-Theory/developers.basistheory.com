...
<Alert type={Alerts.WARNING}>
  The Basis Theory JS SDK is not compatible with <a href="https://create-react-app.dev/">Create React App</a> <code>v5.0.0</code> or above 
  due to a known <a href="https://github.com/facebook/create-react-app/issues/11889">issue</a>.
  Please use CRA <code>v4.0.3</code> or below when working with Basis Theory JS. 
</Alert>
