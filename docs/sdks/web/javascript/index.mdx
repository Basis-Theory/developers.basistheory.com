...
<Alert type={Alerts.ERROR}>This SDK has been deprecated for usage outside of [Reactors](/docs/api/reactors). Visit [web-elements](/docs/sdks/web/web-elements/) for the latest elements SDK and [node-sdk](/docs/sdks/server-side/node) for the latest JS SDK. For any questions, contact [support@basistheory.com](mailto:support@basistheory.com).</Alert>
