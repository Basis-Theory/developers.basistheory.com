...
const requestBody = {
  ...
  expiration_date1: cardExpirationDateElement.format("yyyy-MM"), // returns 2025-04
  expiration_date2: cardExpirationDateElement.format("MM"),      // returns 04
  expiration_date3: cardExpirationDateElement.format("M"),       // returns 4
  expiration_date4: cardExpirationDateElement.format("MM/yyyy"), // returns 04/2025
  expiration_date4: cardExpirationDateElement.format("yy"),      // returns 25
  ...
}
```
