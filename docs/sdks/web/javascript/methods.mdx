...
BasisTheory.post('https://www.api.thirdpartydomain.com/resources', {
    sensitiveData: sensitiveDataElement,
    nonSensitiveData: "plainText", // see warning on plain text data
    otherData: {
      someInteger: 20,
...
BasisTheory.put('https://www.api.thirdpartydomain.com/resources/id', {
    sensitiveData: sensitiveDataElement,
    nonSensitiveData: "plainText", // see warning on plain text data
    otherData: {
      someInteger: 20,
...
BasisTheory.patch('https://www.api.thirdpartydomain.com/resources/id', {
    sensitiveData: sensitiveDataElement,
    nonSensitiveData: "plainText", // see warning on plain text data
    otherData: {
      someInteger: 20,
...
### BasisTheory Service Errors

Element services could throw an error based on client-side validations or if the server rejects the request.
