...
| `transform`        | false    | _RegExp_  | true      | [`text`](/docs/sdks/web/javascript/types#text-element)                                                                                                                                                                                                                                                                      | [`RegExp` object or array](#transform) used to modify user input before [tokenization](/docs/sdks/web/javascript/methods#tokenization-services)                                            |
...
| `validation`       | false    | _RegExp_  | true      | [`text`](/docs/sdks/web/javascript/types#text-element)                                                                                                                                                                                                                                                                      | [`RegExp` object] used to validate user input (on match) before [tokenization](/docs/sdks/web/javascript/methods#tokenization-services)                                                    |
...
The mask will be displayed as the user is typing, and will be used as the value for [tokenization](/docs/sdks/web/javascript/methods#tokenization-services)
...
before [tokenization](/docs/sdks/web/javascript/methods#tokenization-services).
...
<Alert type={Alerts.WARNING}>
  ...
  <a href="/docs/sdks/web/javascript/lifecycle#mount-element">mount</a> promise.
</Alert>

## Transform

Text elements allow you to modify user input before [tokenization](/docs/sdks/web/javascript/methods#tokenization-services) through the
...
`1234567890` which will be what gets [tokenized](/docs/sdks/web/javascript/methods#tokenization-services).
...
<Alert type={Alerts.WARNING}>
  ...
  provided is valid and not susceptible to catastrophic backtracking. If it
  fails this validation, we will reject the{" "}
  <a href="/docs/sdks/web/javascript/lifecycle#mount-element">mount</a> or{" "}
  <a href="/docs/sdks/web/javascript/lifecycle#update-element">update</a>{" "}
  promise.
</Alert>
