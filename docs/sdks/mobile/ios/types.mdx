...
<Alert>
  ...
  supported by <a href="https://developer.apple.com/documentation/uikit/uitextfield">UITextField</a> are supported by <code>TextElementUITextField</code>.
</Alert>
...
<Alert>
  <code>TextElementUITextField</code> extends the native iOS <a href="https://developer.apple.com/documentation/uikit/uitextfield">UITextField</a> from UIKit, so all standard methods
  supported by <a href="https://developer.apple.com/documentation/uikit/uitextfield">UITextField</a> are supported by <code>TextElementUITextField</code>.
</Alert>
...
<Alert>
  This code example uses Basis Theory <Link to="/docs/sdks/mobile/ios/services#http-client-services">HTTP Client</Link>
</Alert>
