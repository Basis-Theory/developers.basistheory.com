...
Proxy provides a simple way to send data securely using an element and/or retrieve data back into an element utilizing our [proxy](/docs/api/proxies/invoke-ephemeral-proxies) service. To accomplish this, simply construct your `proxy` request like this:
