...
| metadata  | An object that contains [metadata](/docs/sdks/mobile/ios/events#using-metadata-for-event-values) about the element state in regards to the inputted value.
