...
To add the Basis Theory iOS package using [Swift Package Manager](https://www.swift.org/package-manager/) via [XCode](https://developer.apple.com/xcode/), open Xcode and click on File -> Add Packages, search for "https://github.com/Basis-Theory/basistheory-ios" and click on "Copy Dependency".
