...
description: The Basis Theory 3DS Mobile SDK makes it easy to start a 3DS transaction from the browser. Learn More.
...
The Basis Theory 3DS Mobile SDK makes it easy to start a 3DS transaction from the browser.
