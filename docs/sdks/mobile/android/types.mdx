...
If the [CardNumberElement](/docs/sdks/mobile/android/types#CardNumberElement) is bound to a [CardVerificationCodeElement](/docs/sdks/mobile/android/types#CardVerificationCodeElement),
