...
| inputType           | `enum`                   | Indicates which type of virtual keyboard to display while editing and how to display data entered into the Element. See [Input Types](/docs/sdks/mobile/android/options#input-types) for details.                                                                      |
| mask                | `string`                 | A string defining the [mask](/docs/sdks/mobile/android/options#mask) applied to this Element, e.g. (`###-##-####`).                                                                                                                                                    |
| removeDefaultStyles | `boolean`                | Removes the default Android styling on the underlying EditText. Defaults to `true`.                                                                                                                                                                                    |
...
| typeface            | `enum`                   | The [typeface](https://developer.android.com/reference/android/widget/TextView#attr_android:typeface) (normal, sans, serif, monospace) for the text. To fully customize the font family and text style, set `TextElement.typeface` programmatically.                   |
