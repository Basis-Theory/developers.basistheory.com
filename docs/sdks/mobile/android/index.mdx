...
<Alert type={Alerts.WARNING}>
  ...
  the usage of anonymous objects to call some SDK methods such as [tokenize](/docs/sdks/mobile/android/services#tokenize), might lead to unexpected behavior.

  Creating dedicated classes along with ProGuard rules to preserve them solves this problem.
</Alert>
