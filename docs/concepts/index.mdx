...
import Question from "@site/static/img/getting-started/icons/question.svg";
...
<Intro
  ...
  img={{
    light: "/img/getting-started/concepts/logo.svg",
    dark: "/img/getting-started/concepts/logo-dark.svg",
  }}
/>
