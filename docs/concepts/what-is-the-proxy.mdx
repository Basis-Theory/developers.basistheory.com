...
4. Navigate to [Basis Theory Portal](https://portal.basistheory.com/proxies), find your Proxy and enter its details page. Click the "Request Custom Hostname" button, fill in the necessary information, and submit the request
...
- [Receive Cards via API / Webhooks](/docs/guides/collect/receive-cards)
