...
2. Own a domain with a valid SSL certificate
3. We register your domain with our DNS provider
4. Create a CNAME record pointing to `btproxy.cloud`
5. Create a new TXT record to validate ownership
