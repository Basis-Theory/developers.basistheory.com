...
Basis Theory Elements are simple, secure, developer-friendly inputs that empower developers to collect sensitive data
...
Data entered by your end users into an **Element** is tokenized and secured within Basis Theory's certified Vault, without your application
