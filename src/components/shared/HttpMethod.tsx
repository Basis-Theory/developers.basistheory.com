...
export const HttpMethod = ({ method, endpoint }: HttpMethod) => {
  ...
  return (
    <div className={clsx(styles.container)}>
      <Pill className={pillClassOverrides}>{method}</Pill> {endpoint}
